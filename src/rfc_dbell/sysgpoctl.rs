...
impl R {
    ...
    #[doc = "Bits 12:15 - RF Core GPO control bit 3. Selects which signal to output on the RF Core GPO line 3."]
    #[inline]
    ...
    #[doc = "Bits 8:11 - RF Core GPO control bit 2. Selects which signal to output on the RF Core GPO line 2."]
    #[inline]
    ...
    #[doc = "Bits 4:7 - RF Core GPO control bit 1. Selects which signal to output on the RF Core GPO line 1."]
    #[inline]
    ...
    #[doc = "Bits 0:3 - RF Core GPO control bit 0. Selects which signal to output on the RF Core GPO line 0."]
    #[inline]
