...
impl R {
    ...
    #[doc = "Bits 0:1 - 00: Disable clock 01: Disable clock when system CPU is in DeepSleep 11: Enable clock For changes to take effect, CLKLOADCTL.LOAD needs to be written"]
    #[inline]
