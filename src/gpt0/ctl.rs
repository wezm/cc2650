...
impl R {
    ...
    #[doc = "Bit 14 - GPT Timer B PWM Output Level 0: Output is unaffected. 1: Output is inverted."]
    #[inline]
    ...
    #[doc = "Bit 9 - GPT Timer B Stall Enable"]
    #[inline]
    ...
    #[doc = "Bit 6 - GPT Timer A PWM Output Level"]
    #[inline]
    ...
    #[doc = "Bits 4:5 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bits 2:3 - GPT Timer A Event Mode The values in this register are defined as follows: Value Description 0x0 Positive edge 0x1 Negative edge 0x2 Reserved 0x3 Both edges Note: If PWM output inversion is enabled, edge detection interrupt behavior is reversed. Thus, if a positive-edge interrupt trigger has been set and the PWM inversion generates a postive edge, no event-trigger interrupt asserts. Instead, the interrupt is generated on the negative edge of the PWM signal."]
    #[inline]
    ...
    #[doc = "Bit 1 - GPT Timer A Stall Enable"]
    #[inline]
