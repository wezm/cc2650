...
impl R {
    ...
    #[doc = "Bit 11 - GPTM Timer A PWM Legacy Operation 0 Legacy operation with CCP pin driven Low when the TAILR register is reloaded after the timer reaches 0. 1 CCP is driven High when the TAILR register is reloaded after the timer reaches 0. This bit is only valid in PWM mode."]
    #[inline]
    ...
    #[doc = "Bit 8 - GPT Timer A PWM Interval Load Write"]
    #[inline]
    ...
    #[doc = "Bit 7 - GPT Timer A Snap-Shot Mode"]
    #[inline]
    ...
    #[doc = "Bit 6 - GPT Timer A Wait-On-Trigger"]
    #[inline]
    ...
    #[doc = "Bit 5 - GPT Timer A Match Interrupt Enable"]
    #[inline]
    ...
    #[doc = "Bit 4 - GPT Timer A Count Direction"]
    #[inline]
    ...
    #[doc = "Bit 3 - GPT Timer A Alternate Mode Note: To enable PWM mode, you must also clear TACM and then configure TAMR field to 0x2."]
    #[inline]
    ...
    #[doc = "Bit 2 - GPT Timer A Capture Mode"]
    #[inline]
    ...
    #[doc = "Bits 0:1 - GPT Timer A Mode 0x0 Reserved 0x1 One-Shot Timer mode 0x2 Periodic Timer mode 0x3 Capture mode The Timer mode is based on the timer configuration defined by bits 2:0 in the CFG register"]
    #[inline]
