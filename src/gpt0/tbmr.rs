...
impl R {
    ...
    #[doc = "Bit 12 - One-Shot/Periodic Interrupt Mode"]
    #[inline]
    ...
    #[doc = "Bit 11 - GPTM Timer B PWM Legacy Operation 0 Legacy operation with CCP pin driven Low when the TBILR register is reloaded after the timer reaches 0. 1 CCP is driven High when the TBILR register is reloaded after the timer reaches 0. This bit is only valid in PWM mode."]
    #[inline]
    ...
    #[doc = "Bit 8 - GPT Timer B PWM Interval Load Write"]
    #[inline]
    ...
    #[doc = "Bit 7 - GPT Timer B Snap-Shot Mode"]
    #[inline]
    ...
    #[doc = "Bit 6 - GPT Timer B Wait-On-Trigger"]
    #[inline]
    ...
    #[doc = "Bit 5 - GPT Timer B Match Interrupt Enable."]
    #[inline]
    ...
    #[doc = "Bit 4 - GPT Timer B Count Direction"]
    #[inline]
    ...
    #[doc = "Bit 3 - GPT Timer B Alternate Mode Note: To enable PWM mode, you must also clear TBCM bit and configure TBMR field to 0x2."]
    #[inline]
    ...
    #[doc = "Bit 2 - GPT Timer B Capture Mode"]
    #[inline]
    ...
    #[doc = "Bits 0:1 - GPT Timer B Mode 0x0 Reserved 0x1 One-Shot Timer mode 0x2 Periodic Timer mode 0x3 Capture mode The Timer mode is based on the timer configuration defined by bits 2:0 in the CFG register"]
    #[inline]
