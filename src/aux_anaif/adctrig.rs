...
impl W {
    ...
    #[doc = "Bit 0 - Manual ADC trigger. 0: No effect. 1: Single ADC trigger. To manually trigger the ADC, you must set ADCCTL.START_SRC to NO_EVENT<n> to avoid conflict with event-driven ADC trigger."]
    #[inline]
