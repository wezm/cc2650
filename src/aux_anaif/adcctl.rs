...
impl R {
    ...
    #[doc = "Bit 13 - Select active polarity for START_SRC event."]
    #[inline]
    ...
    #[doc = "Bits 8:12 - Select ADC trigger event source from the asynchronous AUX event bus. Set START_SRC to NO_EVENT<n> if you want to trigger the ADC manually through ADCTRIG.START."]
    #[inline]
    ...
    #[doc = "Bits 0:1 - ADC interface command. Non-enumerated values are not supported. The written value is returned when read."]
    #[inline]
