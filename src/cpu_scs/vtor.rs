...
impl R {
    ...
    #[doc = "Bits 7:29 - Bits 29 down to 7 of the vector table base offset."]
    #[inline]
    ...
    #[doc = "Bits 0:6 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
