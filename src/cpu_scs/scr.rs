...
impl SLEEPDEEPR {
    ...
    pub fn bit(&self) -> bool {
        match *self {
            SLEEPDEEPR::DEEPSLEEP => true,
            SLEEPDEEPR::SLEEP => false,
        }
    }
    #[allow(missing_docs)]
    #[doc(hidden)]
...
impl SLEEPDEEPW {
    ...
    pub fn _bits(&self) -> bool {
        match *self {
            SLEEPDEEPW::DEEPSLEEP => true,
            SLEEPDEEPW::SLEEP => false,
        }
    }
}
#[doc = r" Proxy"]
...
impl<'a> _SLEEPDEEPW<'a> {
    ...
    pub fn deepsleep(self) -> &'a mut W {
        self.variant(SLEEPDEEPW::DEEPSLEEP)
    }
    #[doc = "Sleep"]
    #[inline]
    pub fn sleep(self) -> &'a mut W {
        self.variant(SLEEPDEEPW::SLEEP)
    }
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    #[doc = "Bit 4 - Send Event on Pending bit: 0: Only enabled interrupts or events can wakeup the processor, disabled interrupts are excluded 1: Enabled events and all interrupts, including disabled interrupts, can wakeup the processor. When an event or interrupt enters pending state, the event signal wakes up the processor from WFE. If the processor is not waiting for an event, the event is registered and affects the next WFE. The processor also wakes up on execution of an SEV instruction."]
    #[inline]
    ...
    #[doc = "Bit 1 - Sleep on exit when returning from Handler mode to Thread mode. Enables interrupt driven applications to avoid returning to empty main application. 0: Do not sleep when returning to thread mode 1: Sleep on ISR exit"]
    #[inline]
