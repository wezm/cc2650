...
impl R {
    ...
    #[doc = "Bit 7 - Must be set to 0 to set TPR. If set to 1, a write to TPR will be ignored."]
    #[inline]
    pub fn tpr_7(&self) -> TPR_7R {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 7;
