...
impl R {
    ...
    #[doc = "Bits 1:7 - I2C master slave address Defines which slave is addressed for the transaction in master mode"]
    #[inline]
    pub fn sa(&self) -> SAR {
        let bits = {
            const MASK: u8 = 127;
    ...
    #[doc = "Bit 0 - Receive or Send This bit-field specifies if the next operation is a receive (high) or a transmit/send (low) from the addressed slave SA."]
    #[inline]
    pub fn rs(&self) -> RSR {
        RSR::_from({
            const MASK: bool = true;
