...
impl R {
    ...
    #[doc = "Bit 8 - Indicates that triggers are inserted when a trigger pin is asserted."]
    #[inline]
    ...
    #[doc = "Bit 1 - Enable continuous formatting: 0: Continuous formatting disabled 1: Continuous formatting enabled"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 8 - Indicates that triggers are inserted when a trigger pin is asserted."]
    #[inline]
    pub fn trigin(&mut self) -> _TRIGINW {
        _TRIGINW { w: self }
    }
    #[doc = "Bits 2:7 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 1 - Enable continuous formatting: 0: Continuous formatting disabled 1: Continuous formatting enabled"]
    #[inline]
    pub fn enfcont(&mut self) -> _ENFCONTW {
        _ENFCONTW { w: self }
    }
    #[doc = "Bit 0 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
