...
impl R {
    ...
    #[doc = "Bits 0:10 - Internal. Only to be used through TI provided API."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 11:15 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn block(&mut self) -> _BLOCKW {
        _BLOCKW { w: self }
    }
    #[doc = "Bits 0:10 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn row(&mut self) -> _ROWW {
        _ROWW { w: self }
    }
}
