...
impl R {
    ...
    #[inline]
    pub fn vhvct_pv(&self) -> VHVCT_PVR {
        let bits = {
            const MASK: u8 = 15;
            const OFFSET: u8 = 0;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
impl W {
    ...
    #[doc = "Bits 20:23 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn trim13_e(&mut self) -> _TRIM13_EW {
        _TRIM13_EW { w: self }
    }
    #[doc = "Bits 16:19 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn vhvct_e(&mut self) -> _VHVCT_EW {
        _VHVCT_EW { w: self }
    }
    #[doc = "Bits 4:7 - Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 0:3 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn vhvct_pv(&mut self) -> _VHVCT_PVW {
        _VHVCT_PVW { w: self }
    }
}
