...
impl W {
    ...
    #[doc = "Bit 25 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn rvf_int(&mut self) -> _RVF_INTW {
        _RVF_INTW { w: self }
    }
    #[doc = "Bit 24 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn fsm_done(&mut self) -> _FSM_DONEW {
        _FSM_DONEW { w: self }
    }
}
