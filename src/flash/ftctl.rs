...
#[doc = r" Proxy"]
pub struct _WDATA_BLK_CLRW<'a> {
    w: &'a mut W,
}
impl<'a> _WDATA_BLK_CLRW<'a> {
...
impl R {
    ...
    #[inline]
    pub fn wdata_blk_clr(&self) -> WDATA_BLK_CLRR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 16;
    ...
    #[doc = "Bits 2:15 - Internal. Only to be used through TI provided API."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 16 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn wdata_blk_clr(&mut self) -> _WDATA_BLK_CLRW {
        _WDATA_BLK_CLRW { w: self }
    }
    #[doc = "Bit 1 - Internal. Only to be used through TI provided API."]
    #[inline]
