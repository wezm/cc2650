...
#[doc = r" Proxy"]
pub struct _VSTAT_CNTW<'a> {
    w: &'a mut W,
}
impl<'a> _VSTAT_CNTW<'a> {
...
impl R {
    ...
    #[inline]
    pub fn vstat_cnt(&self) -> VSTAT_CNTR {
        let bits = {
            const MASK: u8 = 15;
            const OFFSET: u8 = 12;
...
impl W {
    ...
    #[doc = "Bits 12:15 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn vstat_cnt(&mut self) -> _VSTAT_CNTW {
        _VSTAT_CNTW { w: self }
    }
}
