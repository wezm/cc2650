...
impl R {
    ...
    #[doc = "Bits 14:29 - Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 9:12 - Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 0:8 - Internal. Only to be used through TI provided API."]
    #[inline]
