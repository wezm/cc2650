...
impl W {
    ...
    #[doc = "Bits 8:15 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn pgm_osu(&mut self) -> _PGM_OSUW {
        _PGM_OSUW { w: self }
    }
    #[doc = "Bits 0:7 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn era_osu(&mut self) -> _ERA_OSUW {
        _ERA_OSUW { w: self }
    }
}
