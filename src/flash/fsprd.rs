...
impl R {
    ...
    #[inline]
    pub fn dis_preempt(&self) -> DIS_PREEMPTR {
        let bits = {
...
impl W {
    ...
    #[doc = "Bits 8:15 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn rmbsem(&mut self) -> _RMBSEMW {
        _RMBSEMW { w: self }
    }
    #[doc = "Bit 1 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn rm1(&mut self) -> _RM1W {
        _RM1W { w: self }
    }
    #[doc = "Bit 0 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn rm0(&mut self) -> _RM0W {
        _RM0W { w: self }
    }
}
