...
#[doc = r" Proxy"]
pub struct _OTPPROTDISW<'a> {
    w: &'a mut W,
}
impl<'a> _OTPPROTDISW<'a> {
...
impl W {
    ...
    #[doc = "Bit 16 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn otpprotdis(&mut self) -> _OTPPROTDISW {
        _OTPPROTDISW { w: self }
    }
    #[doc = "Bits 8:15 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn bagp(&mut self) -> _BAGPW {
        _BAGPW { w: self }
    }
    #[doc = "Bits 0:7 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn vreads(&mut self) -> _VREADSW {
        _VREADSW { w: self }
    }
}
