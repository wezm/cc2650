...
#[doc = r" Proxy"]
pub struct _CHAIN_SELW<'a> {
    w: &'a mut W,
}
impl<'a> _CHAIN_SELW<'a> {
...
impl R {
    ...
    #[doc = "Bits 27:31 - Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[inline]
    pub fn chain_sel(&self) -> CHAIN_SELR {
        let bits = {
            const MASK: u8 = 7;
            const OFFSET: u8 = 24;
            ((self.bits >> OFFSET) & MASK as u32) as u8
    ...
    #[inline]
    pub fn write_en(&self) -> WRITE_ENR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 17;
    ...
    #[inline]
    pub fn efuse_en(&self) -> EFUSE_ENR {
        let bits = {
            const MASK: u8 = 15;
            const OFFSET: u8 = 0;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
impl W {
    ...
    #[doc = "Bits 24:26 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn chain_sel(&mut self) -> _CHAIN_SELW {
        _CHAIN_SELW { w: self }
    }
    #[doc = "Bit 17 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn write_en(&mut self) -> _WRITE_ENW {
        _WRITE_ENW { w: self }
    }
    #[doc = "Bit 16 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn bp_sel(&mut self) -> _BP_SELW {
        _BP_SELW { w: self }
    }
    #[doc = "Bit 8 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn ef_clrz(&mut self) -> _EF_CLRZW {
        _EF_CLRZW { w: self }
    }
    #[doc = "Bit 4 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn ef_test(&mut self) -> _EF_TESTW {
        _EF_TESTW { w: self }
    }
    #[doc = "Bits 0:3 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn efuse_en(&mut self) -> _EFUSE_ENW {
        _EFUSE_ENW { w: self }
    }
}
