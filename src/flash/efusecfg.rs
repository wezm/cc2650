...
#[doc = r" Proxy"]
pub struct _IDLEGATINGW<'a> {
    w: &'a mut W,
}
impl<'a> _IDLEGATINGW<'a> {
...
#[doc = r" Proxy"]
pub struct _SLAVEPOWERW<'a> {
    w: &'a mut W,
}
impl<'a> _SLAVEPOWERW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl R {
    ...
    #[doc = "Bits 9:31 - Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 3:4 - Internal. Only to be used through TI provided API."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 8 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn idlegating(&mut self) -> _IDLEGATINGW {
        _IDLEGATINGW { w: self }
    }
    #[doc = "Bits 3:4 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn slavepower(&mut self) -> _SLAVEPOWERW {
        _SLAVEPOWERW { w: self }
    }
    #[doc = "Bit 0 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn gating(&mut self) -> _GATINGW {
        _GATINGW { w: self }
    }
}
