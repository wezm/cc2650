...
#[doc = r" Proxy"]
pub struct _SHIFT_DONEW<'a> {
    w: &'a mut W,
}
impl<'a> _SHIFT_DONEW<'a> {
...
impl R {
    ...
    #[inline]
    pub fn shift_done(&self) -> SHIFT_DONER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 0;
...
impl W {
    ...
    #[doc = "Bit 0 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn shift_done(&mut self) -> _SHIFT_DONEW {
        _SHIFT_DONEW { w: self }
    }
}
