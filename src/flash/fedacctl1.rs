...
#[doc = r" Proxy"]
pub struct _SUSP_IGNRW<'a> {
    w: &'a mut W,
}
impl<'a> _SUSP_IGNRW<'a> {
...
impl R {
    ...
    #[inline]
    pub fn susp_ignr(&self) -> SUSP_IGNRR {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 24;
...
impl W {
    ...
    #[doc = "Bit 24 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn susp_ignr(&mut self) -> _SUSP_IGNRW {
        _SUSP_IGNRW { w: self }
    }
}
