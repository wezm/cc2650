...
impl R {
    ...
    #[doc = "Bit 21 - Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bit 18 - Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 14:17 - Internal. Only to be used through TI provided API."]
    #[inline]
