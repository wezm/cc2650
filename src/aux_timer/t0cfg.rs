...
impl R {
    ...
    #[doc = "Bit 13 - Tick source polarity for Timer 0."]
    #[inline]
    ...
    #[doc = "Bits 8:12 - Select Timer 0 tick source from the synchronous event bus."]
    #[inline]
    ...
    #[doc = "Bit 1 - Timer 0 mode. Configure source for Timer 0 prescaler."]
    #[inline]
