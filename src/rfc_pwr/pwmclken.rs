...
impl R {
    ...
    #[doc = "Bit 10 - Enable clock to the RF Core Tracer (RFCTRC) module."]
    #[inline]
    ...
    #[doc = "Bit 9 - Enable clock to the Frequency Synthesizer Calibration Accelerator (FSCA) module."]
    #[inline]
    ...
    #[doc = "Bit 8 - Enable clock to the Packet Handling Accelerator (PHA) module."]
    #[inline]
    ...
    #[doc = "Bit 7 - Enable clock to the Radio Timer (RAT) module."]
    #[inline]
    ...
    #[doc = "Bit 6 - Enable clock to the RF Engine RAM module."]
    #[inline]
    ...
    #[doc = "Bit 5 - Enable clock to the RF Engine (RFE) module."]
    #[inline]
    ...
    #[doc = "Bit 4 - Enable clock to the Modem RAM module."]
    #[inline]
    ...
    #[doc = "Bit 3 - Enable clock to the Modem (MDM) module."]
    #[inline]
    ...
    #[doc = "Bit 2 - Enable clock to the Command and Packet Engine (CPE) RAM module. As part of RF Core initialization, set this bit together with CPE bit to enable CPE to boot."]
    #[inline]
    ...
    #[doc = "Bit 1 - Enable processor clock (hclk) to the Command and Packet Engine (CPE). As part of RF Core initialization, set this bit together with CPERAM bit to enable CPE to boot."]
    #[inline]
