...
#[doc = r" Proxy"]
pub struct _PULSE_WIDTHW<'a> {
    w: &'a mut W,
}
impl<'a> _PULSE_WIDTHW<'a> {
...
impl W {
    ...
    #[doc = "Bits 0:15 - The value written to this register determines the width of the active high PWM pulse (pwm_debug), which starts together with MSB of the first output word in a DMA buffer: 0x0000: Constant low 0x0001: Width of the pulse (number of BCLK cycles, here 1). ... 0xFFFE: Width of the pulse (number of BCLK cycles, here 65534). 0xFFFF: Constant high"]
    #[inline]
    pub fn pulse_width(&mut self) -> _PULSE_WIDTHW {
        _PULSE_WIDTHW { w: self }
    }
}
