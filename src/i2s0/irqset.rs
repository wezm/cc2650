...
impl W {
    ...
    #[doc = "Bit 5 - 1: Sets the interrupt of IRQFLAGS.AIF_DMA_IN (unless a auto clear criteria was given at the same time, in which the set will be ignored)"]
    #[inline]
    pub fn aif_dma_in(&mut self) -> _AIF_DMA_INW {
        _AIF_DMA_INW { w: self }
    }
    #[doc = "Bit 4 - 1: Sets the interrupt of IRQFLAGS.AIF_DMA_OUT (unless a auto clear criteria was given at the same time, in which the set will be ignored)"]
    #[inline]
    pub fn aif_dma_out(&mut self) -> _AIF_DMA_OUTW {
        _AIF_DMA_OUTW { w: self }
    }
    #[doc = "Bit 3 - 1: Sets the interrupt of IRQFLAGS.WCLK_TIMEOUT"]
    #[inline]
    pub fn wclk_timeout(&mut self) -> _WCLK_TIMEOUTW {
        _WCLK_TIMEOUTW { w: self }
    }
    #[doc = "Bit 2 - 1: Sets the interrupt of IRQFLAGS.BUS_ERR"]
    #[inline]
    pub fn bus_err(&mut self) -> _BUS_ERRW {
        _BUS_ERRW { w: self }
    }
    #[doc = "Bit 1 - 1: Sets the interrupt of IRQFLAGS.WCLK_ERR"]
    #[inline]
    pub fn wclk_err(&mut self) -> _WCLK_ERRW {
        _WCLK_ERRW { w: self }
    }
    #[doc = "Bit 0 - 1: Sets the interrupt of IRQFLAGS.PTR_ERR"]
    #[inline]
