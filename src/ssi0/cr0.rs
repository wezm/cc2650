...
impl R {
    ...
    #[doc = "Bits 8:15 - Serial clock rate: This is used to generate the transmit and receive bit rate of the SSI. The bit rate is (SSI's clock frequency)/((SCR+1)*CPSR.CPSDVSR). SCR is a value from 0-255."]
    #[inline]
    ...
    #[doc = "Bit 7 - CLKOUT phase (Motorola SPI frame format only) This bit selects the clock edge that captures data and enables it to change state. It has the most impact on the first bit transmitted by either permitting or not permitting a clock transition before the first data capture edge."]
    #[inline]
    ...
    #[doc = "Bit 6 - CLKOUT polarity (Motorola SPI frame format only)"]
    #[inline]
    ...
    #[doc = "Bits 4:5 - Frame format. The supported frame formats are Motorola SPI, TI synchronous serial and National Microwire. Value 0'b11 is reserved and shall not be used."]
    #[inline]
    ...
    #[doc = "Bits 0:3 - Data Size Select. Values 0b0000, 0b0001, 0b0010 are reserved and shall not be used."]
    #[inline]
