...
impl R {
    ...
    #[doc = "Bit 29 - Enable 32 kHz clock to AUX_COMPB."]
    #[inline]
    ...
    #[doc = "Bits 0:28 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 30:31 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    pub fn spare30(&mut self) -> _SPARE30W {
        _SPARE30W { w: self }
    }
    #[doc = "Bit 29 - Enable 32 kHz clock to AUX_COMPB."]
    #[inline]
