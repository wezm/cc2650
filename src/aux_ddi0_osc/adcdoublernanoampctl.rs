...
impl super::ADCDOUBLERNANOAMPCTL {
...
#[doc = r" Value of the field"]
pub struct NANOAMP_BIAS_ENABLER {
    bits: bool,
}
impl NANOAMP_BIAS_ENABLER {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
...
#[doc = r" Proxy"]
pub struct _NANOAMP_BIAS_ENABLEW<'a> {
    w: &'a mut W,
}
impl<'a> _NANOAMP_BIAS_ENABLEW<'a> {
...
#[doc = r" Proxy"]
pub struct _ADC_IREF_CTRLW<'a> {
    w: &'a mut W,
}
impl<'a> _ADC_IREF_CTRLW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 3;
...
impl R {
    ...
    #[inline]
    pub fn nanoamp_bias_enable(&self) -> NANOAMP_BIAS_ENABLER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 24;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        NANOAMP_BIAS_ENABLER { bits }
    }
    ...
    #[doc = "Bits 6:22 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[inline]
    pub fn adc_iref_ctrl(&self) -> ADC_IREF_CTRLR {
        let bits = {
            const MASK: u8 = 3;
            const OFFSET: u8 = 0;
            ((self.bits >> OFFSET) & MASK as u32) as u8
...
impl W {
    ...
    #[doc = "Bit 24 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn nanoamp_bias_enable(&mut self) -> _NANOAMP_BIAS_ENABLEW {
        _NANOAMP_BIAS_ENABLEW { w: self }
    }
    #[doc = "Bit 23 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior"]
    #[inline]
    pub fn spare23(&mut self) -> _SPARE23W {
        _SPARE23W { w: self }
    }
    #[doc = "Bits 6:22 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bits 0:1 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn adc_iref_ctrl(&mut self) -> _ADC_IREF_CTRLW {
        _ADC_IREF_CTRLW { w: self }
    }
}
