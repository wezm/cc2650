...
impl R {
    ...
    #[doc = "Bit 31 - Set based on the accurate high frequency XTAL."]
    #[inline]
    ...
    #[doc = "Bit 30 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 29 - Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 26:27 - Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 23:24 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bits 17:21 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 13 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 9 - Enable clock loss detection and hence the indicators to system controller. Checks both SCLK_HF and SCLK_LF clock loss indicators. 0: Disable 1: Enable Clock loss detection must be disabled when changing the sclk_lf source. STAT0.SCLK_LF_SRC can be polled to determine when a change to a new sclk_lf source has completed."]
    #[inline]
    ...
    #[doc = "Bits 7:8 - Source select for aclk_tdc. 00: RCOSC_HF (48MHz) 01: RCOSC_HF (24MHz) 10: XOSC_HF (24MHz) 11: Not used"]
    #[inline]
    ...
    #[doc = "Bits 5:6 - Source select for aclk_ref 00: RCOSC_HF derived (31.25kHz) 01: XOSC_HF derived (31.25kHz) 10: RCOSC_LF (32kHz) 11: XOSC_LF (32.768kHz)"]
    #[inline]
    ...
    #[doc = "Bits 2:3 - Source select for sclk_lf"]
    #[inline]
    ...
    #[doc = "Bit 0 - Source select for sclk_hf. XOSC option is supported for test and debug only and should be used when the XOSC_HF is running."]
    #[inline]
