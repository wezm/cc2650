...
impl W {
    ...
    #[inline]
    pub fn prtoctrl(&mut self) -> _PRTOCTRLW {
        _PRTOCTRLW { w: self }
    }
    #[doc = "Bits 1:4 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    pub fn reserved1(&mut self) -> _RESERVED1W {
        _RESERVED1W { w: self }
    }
    #[doc = "Bit 0 - Enables the controller: 0: Disables the controller 1: Enables the controller"]
    #[inline]
