...
impl R {
    ...
    #[doc = "Bits 16:21 - Event selector for AON_PROG2 event. AON Event Source id# selecting event routed to EVENT as AON_PROG2 event."]
    #[inline]
    ...
    #[doc = "Bits 8:13 - Event selector for AON_PROG1 event. AON Event Source id# selecting event routed to EVENT as AON_PROG1 event."]
    #[inline]
    ...
    #[doc = "Bits 0:5 - Event selector for AON_PROG0 event. AON Event Source id# selecting event routed to EVENT as AON_PROG0 event."]
    #[inline]
