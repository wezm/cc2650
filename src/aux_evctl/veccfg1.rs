...
impl R {
    ...
    #[doc = "Bits 15:31 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 14 - Vector 3 trigger event polarity. To manually trigger vector 3 execution: - AUX_SCE must sleep. - Set VEC3_EV to a known static value. - Toggle VEC3_POL twice."]
    #[inline]
    ...
    #[doc = "Bit 13 - Vector 3 trigger enable. When enabled, VEC3_EV event with VEC3_POL polarity triggers a jump to vector # 3 when AUX_SCE sleeps. Lower vectors (0, 1, and 2) have priority."]
    #[inline]
    ...
    #[doc = "Bits 8:12 - Select vector 3 trigger source event."]
    #[inline]
    ...
    #[doc = "Bit 6 - Vector 2 trigger event polarity. To manually trigger vector 2 execution: - AUX_SCE must sleep. - Set VEC2_EV to a known static value. - Toggle VEC2_POL twice."]
    #[inline]
    ...
    #[doc = "Bit 5 - Vector 2 trigger enable. When enabled, VEC2_EV event with VEC2_POL polarity triggers a jump to vector # 2 when AUX_SCE sleeps. Lower vectors (0 and 1) have priority."]
    #[inline]
    ...
    #[doc = "Bits 0:4 - Select vector 2 trigger source event."]
    #[inline]
