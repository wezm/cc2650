...
impl W {
    ...
    #[doc = "Bit 2 - Software event flag 2. 0: No effect. 1: Set software event flag 2."]
    #[inline]
    pub fn swev2(&mut self) -> _SWEV2W {
        _SWEV2W { w: self }
    }
    #[doc = "Bit 1 - Software event flag 1. 0: No effect. 1: Set software event flag 1."]
    #[inline]
    pub fn swev1(&mut self) -> _SWEV1W {
        _SWEV1W { w: self }
    }
    #[doc = "Bit 0 - Software event flag 0. 0: No effect. 1: Set software event flag 0."]
    #[inline]
