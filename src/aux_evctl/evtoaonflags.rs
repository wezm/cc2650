...
impl R {
    ...
    #[doc = "Bit 8 - This event flag is set when level selected by EVTOAONPOL.TIMER1_EV occurs on EVSTAT0.TIMER1_EV."]
    #[inline]
    ...
    #[doc = "Bit 7 - This event flag is set when level selected by EVTOAONPOL.TIMER0_EV occurs on EVSTAT0.TIMER0_EV."]
    #[inline]
    ...
    #[doc = "Bit 6 - This event flag is set when level selected by EVTOAONPOL.TDC_DONE occurs on EVSTAT0.TDC_DONE."]
    #[inline]
    ...
    #[doc = "Bit 5 - This event flag is set when level selected by EVTOAONPOL.ADC_DONE occurs on EVSTAT0.ADC_DONE."]
    #[inline]
    ...
    #[doc = "Bit 4 - This event flag is set when edge selected by EVTOAONPOL.AUX_COMPB occurs on EVSTAT0.AUX_COMPB."]
    #[inline]
    ...
    #[doc = "Bit 3 - This event flag is set when edge selected by EVTOAONPOL.AUX_COMPA occurs on EVSTAT0.AUX_COMPA."]
    #[inline]
    ...
    #[doc = "Bit 2 - This event flag is set when software writes a 1 to SWEVSET.SWEV2."]
    #[inline]
    ...
    #[doc = "Bit 1 - This event flag is set when software writes a 1 to SWEVSET.SWEV1."]
    #[inline]
    ...
    #[doc = "Bit 0 - This event flag is set when software writes a 1 to SWEVSET.SWEV0."]
    #[inline]
