...
impl R {
    ...
    #[doc = "Bit 10 - This event flag is set when level selected by EVTOMCUPOL.ADC_IRQ occurs on EVSTAT0.ADC_IRQ."]
    #[inline]
    ...
    #[doc = "Bit 9 - This event flag is set when level selected by EVTOMCUPOL.MCU_OBSMUX0 occurs on EVSTAT0.MCU_OBSMUX0."]
    #[inline]
    ...
    #[doc = "Bit 8 - This event flag is set when level selected by EVTOMCUPOL.ADC_FIFO_ALMOST_FULL occurs on EVSTAT0.ADC_FIFO_ALMOST_FULL."]
    #[inline]
    ...
    #[doc = "Bit 7 - This event flag is set when level selected by EVTOMCUPOL.ADC_DONE occurs on EVSTAT0.ADC_DONE."]
    #[inline]
    ...
    #[doc = "Bit 6 - This event flag is set when level selected by EVTOMCUPOL.SMPH_AUTOTAKE_DONE occurs on EVSTAT0.SMPH_AUTOTAKE_DONE."]
    #[inline]
    ...
    #[doc = "Bit 5 - This event flag is set when level selected by EVTOMCUPOL.TIMER1_EV occurs on EVSTAT0.TIMER1_EV."]
    #[inline]
    ...
    #[doc = "Bit 4 - This event flag is set when level selected by EVTOMCUPOL.TIMER0_EV occurs on EVSTAT0.TIMER0_EV."]
    #[inline]
    ...
    #[doc = "Bit 3 - This event flag is set when level selected by EVTOMCUPOL.TDC_DONE occurs on EVSTAT0.TDC_DONE."]
    #[inline]
    ...
    #[doc = "Bit 2 - This event flag is set when edge selected by EVTOMCUPOL.AUX_COMPB occurs on EVSTAT0.AUX_COMPB."]
    #[inline]
    ...
    #[doc = "Bit 1 - This event flag is set when edge selected by EVTOMCUPOL.AUX_COMPA occurs on EVSTAT0.AUX_COMPA."]
    #[inline]
    ...
    #[doc = "Bit 0 - This event flag is set when level selected by EVTOMCUPOL.AON_WU_EV occurs on the reduction-OR of the AUX_EVCTL:EVSTAT0.RTC_CH2_EV, AUX_EVCTL:EVSTAT0.AON_SW, and AUX_EVCTL:EVSTAT0.AON_PROG_WU events."]
    #[inline]
