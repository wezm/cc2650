...
impl R {
    ...
    #[doc = "Bit 14 - Vector 1 trigger event polarity. To manually trigger vector 1 execution: - AUX_SCE must sleep. - Set VEC1_EV to a known static value. - Toggle VEC1_POL twice."]
    #[inline]
    ...
    #[doc = "Bit 13 - Vector 1 trigger enable. When enabled, VEC1_EV event with VEC1_POL polarity triggers a jump to vector # 1 when AUX_SCE sleeps. Lower vectors (0) have priority."]
    #[inline]
    ...
    #[doc = "Bits 8:12 - Select vector 1 trigger source event."]
    #[inline]
    ...
    #[doc = "Bit 6 - Vector 0 trigger event polarity. To manually trigger vector 0 execution: - AUX_SCE must sleep. - Set VEC0_EV to a known static value. - Toggle VEC0_POL twice."]
    #[inline]
    ...
    #[doc = "Bit 5 - Vector 0 trigger enable. When enabled, VEC0_EV event with VEC0_POL polarity triggers a jump to vector # 0 when AUX_SCE sleeps."]
    #[inline]
    ...
    #[doc = "Bits 0:4 - Select vector 0 trigger source event."]
    #[inline]
