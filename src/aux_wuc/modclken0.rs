...
impl R {
    ...
    #[doc = "Bit 7 - Enables (1) or disables (0) clock for AUX_ADI4."]
    #[inline]
    ...
    #[doc = "Bit 6 - Enables (1) or disables (0) clock for AUX_DDI0_OSC."]
    #[inline]
    ...
    #[doc = "Bit 5 - Enables (1) or disables (0) clock for AUX_TDCIF. Note that the TDC counter and reference clock sources must be requested separately using TDCCLKCTL and REFCLKCTL, respectively."]
    #[inline]
    ...
    #[doc = "Bit 4 - Enables (1) or disables (0) clock for AUX_ANAIF. Note that the ADC internal clock must be requested separately using ADCCLKCTL."]
    #[inline]
    ...
    #[doc = "Bit 3 - Enables (1) or disables (0) clock for AUX_TIMER."]
    #[inline]
    ...
    #[doc = "Bit 2 - Enables (1) or disables (0) clock for AUX_AIODIO1."]
    #[inline]
    ...
    #[doc = "Bit 1 - Enables (1) or disables (0) clock for AUX_AIODIO0."]
    #[inline]
    ...
    #[doc = "Bit 0 - Enables (1) or disables (0) clock for AUX_SMPH."]
    #[inline]
