...
impl R {
    ...
    #[doc = "Bit 5 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 4 - Enables (1) or disables (0) clock for AUX_ANAIF."]
    #[inline]
