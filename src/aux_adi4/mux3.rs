...
impl ADCCOMPB_INR {
    ...
    pub fn bits(&self) -> u8 {
        match *self {
            ADCCOMPB_INR::AUXIO0 => 128,
            ADCCOMPB_INR::AUXIO1 => 64,
            ADCCOMPB_INR::AUXIO2 => 32,
            ADCCOMPB_INR::AUXIO3 => 16,
            ADCCOMPB_INR::AUXIO4 => 8,
            ADCCOMPB_INR::AUXIO5 => 4,
            ADCCOMPB_INR::AUXIO6 => 2,
            ADCCOMPB_INR::AUXIO7 => 1,
            ADCCOMPB_INR::NC => 0,
    ...
    pub fn _from(value: u8) -> ADCCOMPB_INR {
        match value {
            128 => ADCCOMPB_INR::AUXIO0,
            64 => ADCCOMPB_INR::AUXIO1,
            32 => ADCCOMPB_INR::AUXIO2,
            16 => ADCCOMPB_INR::AUXIO3,
            8 => ADCCOMPB_INR::AUXIO4,
            4 => ADCCOMPB_INR::AUXIO5,
            2 => ADCCOMPB_INR::AUXIO6,
            1 => ADCCOMPB_INR::AUXIO7,
            0 => ADCCOMPB_INR::NC,
...
impl ADCCOMPB_INW {
    ...
    pub fn _bits(&self) -> u8 {
        match *self {
            ADCCOMPB_INW::AUXIO0 => 128,
            ADCCOMPB_INW::AUXIO1 => 64,
            ADCCOMPB_INW::AUXIO2 => 32,
            ADCCOMPB_INW::AUXIO3 => 16,
            ADCCOMPB_INW::AUXIO4 => 8,
            ADCCOMPB_INW::AUXIO5 => 4,
            ADCCOMPB_INW::AUXIO6 => 2,
            ADCCOMPB_INW::AUXIO7 => 1,
            ADCCOMPB_INW::NC => 0,
        }
    }
}
...
impl<'a> _ADCCOMPB_INW<'a> {
    ...
    pub fn auxio0(self) -> &'a mut W {
        self.variant(ADCCOMPB_INW::AUXIO0)
    }
    #[doc = "Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn auxio1(self) -> &'a mut W {
        self.variant(ADCCOMPB_INW::AUXIO1)
    }
    #[doc = "Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn auxio2(self) -> &'a mut W {
        self.variant(ADCCOMPB_INW::AUXIO2)
    }
    #[doc = "Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn auxio3(self) -> &'a mut W {
        self.variant(ADCCOMPB_INW::AUXIO3)
    }
    #[doc = "Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn auxio4(self) -> &'a mut W {
        self.variant(ADCCOMPB_INW::AUXIO4)
    }
    #[doc = "Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn auxio5(self) -> &'a mut W {
        self.variant(ADCCOMPB_INW::AUXIO5)
    }
    #[doc = "Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn auxio6(self) -> &'a mut W {
        self.variant(ADCCOMPB_INW::AUXIO6)
    }
    #[doc = "Internal. Only to be used through TI provided API."]
    #[inline]
