...
impl R {
    ...
    #[doc = "Bits 0:7 - This counts the total number folded instructions. This counter initializes to 0 when it is enabled using CTRL.FOLDEVTENA."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 0:7 - This counts the total number folded instructions. This counter initializes to 0 when it is enabled using CTRL.FOLDEVTENA."]
    #[inline]
    pub fn foldcnt(&mut self) -> _FOLDCNTW {
        _FOLDCNTW { w: self }
    }
}
