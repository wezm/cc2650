...
impl R {
    ...
    #[doc = "Bits 8:23 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 7 - This bit is only available in comparator 0. When set, COMP0 will compare against the cycle counter (CYCCNT)."]
    #[inline]
    ...
    #[doc = "Bit 6 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 7 - This bit is only available in comparator 0. When set, COMP0 will compare against the cycle counter (CYCCNT)."]
    #[inline]
    pub fn cycmatch(&mut self) -> _CYCMATCHW {
        _CYCMATCHW { w: self }
    }
    #[doc = "Bit 5 - Emit range field. This bit permits emitting offset when range match occurs. PC sampling is not supported when emit range is enabled. This field only applies for: FUNCTION = 1, 2, 3, 12, 13, 14, and 15."]
    #[inline]
