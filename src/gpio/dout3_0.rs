...
impl W {
    ...
    #[doc = "Bit 24 - Sets the state of the pin that is configured as DIO#3, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio3(&mut self) -> _DIO3W {
        _DIO3W { w: self }
    }
    #[doc = "Bit 16 - Sets the state of the pin that is configured as DIO#2, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio2(&mut self) -> _DIO2W {
        _DIO2W { w: self }
    }
    #[doc = "Bit 8 - Sets the state of the pin that is configured as DIO#1, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio1(&mut self) -> _DIO1W {
        _DIO1W { w: self }
    }
    #[doc = "Bit 0 - Sets the state of the pin that is configured as DIO#0, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
