...
impl W {
    ...
    #[doc = "Bit 24 - Sets the state of the pin that is configured as DIO#19, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio19(&mut self) -> _DIO19W {
        _DIO19W { w: self }
    }
    #[doc = "Bit 16 - Sets the state of the pin that is configured as DIO#18, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio18(&mut self) -> _DIO18W {
        _DIO18W { w: self }
    }
    #[doc = "Bit 8 - Sets the state of the pin that is configured as DIO#17, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio17(&mut self) -> _DIO17W {
        _DIO17W { w: self }
    }
    #[doc = "Bit 0 - Sets the state of the pin that is configured as DIO#16, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
