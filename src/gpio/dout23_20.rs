...
impl W {
    ...
    #[doc = "Bit 24 - Sets the state of the pin that is configured as DIO#23, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio23(&mut self) -> _DIO23W {
        _DIO23W { w: self }
    }
    #[doc = "Bit 16 - Sets the state of the pin that is configured as DIO#22, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio22(&mut self) -> _DIO22W {
        _DIO22W { w: self }
    }
    #[doc = "Bit 8 - Sets the state of the pin that is configured as DIO#21, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio21(&mut self) -> _DIO21W {
        _DIO21W { w: self }
    }
    #[doc = "Bit 0 - Sets the state of the pin that is configured as DIO#20, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
