...
impl W {
    ...
    #[doc = "Bit 24 - Sets the state of the pin that is configured as DIO#7, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio7(&mut self) -> _DIO7W {
        _DIO7W { w: self }
    }
    #[doc = "Bit 16 - Sets the state of the pin that is configured as DIO#6, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio6(&mut self) -> _DIO6W {
        _DIO6W { w: self }
    }
    #[doc = "Bit 8 - Sets the state of the pin that is configured as DIO#5, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio5(&mut self) -> _DIO5W {
        _DIO5W { w: self }
    }
    #[doc = "Bit 0 - Sets the state of the pin that is configured as DIO#4, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
