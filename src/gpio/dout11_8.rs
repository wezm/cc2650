...
impl W {
    ...
    #[doc = "Bit 24 - Sets the state of the pin that is configured as DIO#11, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio11(&mut self) -> _DIO11W {
        _DIO11W { w: self }
    }
    #[doc = "Bit 16 - Sets the state of the pin that is configured as DIO#10, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio10(&mut self) -> _DIO10W {
        _DIO10W { w: self }
    }
    #[doc = "Bit 8 - Sets the state of the pin that is configured as DIO#9, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio9(&mut self) -> _DIO9W {
        _DIO9W { w: self }
    }
    #[doc = "Bit 0 - Sets the state of the pin that is configured as DIO#8, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
