...
impl W {
    ...
    #[doc = "Bit 24 - Sets the state of the pin that is configured as DIO#27, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio27(&mut self) -> _DIO27W {
        _DIO27W { w: self }
    }
    #[doc = "Bit 16 - Sets the state of the pin that is configured as DIO#26, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio26(&mut self) -> _DIO26W {
        _DIO26W { w: self }
    }
    #[doc = "Bit 8 - Sets the state of the pin that is configured as DIO#25, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio25(&mut self) -> _DIO25W {
        _DIO25W { w: self }
    }
    #[doc = "Bit 0 - Sets the state of the pin that is configured as DIO#24, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
