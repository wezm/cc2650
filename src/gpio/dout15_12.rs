...
impl W {
    ...
    #[doc = "Bit 24 - Sets the state of the pin that is configured as DIO#15, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio15(&mut self) -> _DIO15W {
        _DIO15W { w: self }
    }
    #[doc = "Bit 16 - Sets the state of the pin that is configured as DIO#14, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio14(&mut self) -> _DIO14W {
        _DIO14W { w: self }
    }
    #[doc = "Bit 8 - Sets the state of the pin that is configured as DIO#13, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    pub fn dio13(&mut self) -> _DIO13W {
        _DIO13W { w: self }
    }
    #[doc = "Bit 0 - Sets the state of the pin that is configured as DIO#12, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
