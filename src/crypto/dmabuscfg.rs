...
impl R {
    ...
    #[doc = "Bits 12:15 - Maximum burst size that can be performed on the AHB bus"]
    #[inline]
    ...
    #[doc = "Bit 11 - Idle transfer insertion between consecutive burst transfers on AHB"]
    #[inline]
    ...
    #[doc = "Bit 10 - Burst length type of AHB transfer"]
    #[inline]
    ...
    #[doc = "Bit 9 - Locked transform on AHB"]
    #[inline]
    ...
    #[doc = "Bit 8 - Endianess for the AHB master"]
    #[inline]
