...
impl W {
    ...
    #[doc = "Bit 8 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn fallb(&mut self) -> _FALLBW {
        _FALLBW { w: self }
    }
    #[doc = "Bits 6:7 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn highlim(&mut self) -> _HIGHLIMW {
        _HIGHLIMW { w: self }
    }
    #[doc = "Bit 5 - Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn lowlim(&mut self) -> _LOWLIMW {
        _LOWLIMW { w: self }
    }
    #[doc = "Bit 4 - Internal. Only to be used through TI provided API."]
    #[inline]
