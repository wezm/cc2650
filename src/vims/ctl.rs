...
impl R {
    ...
    #[doc = "Bit 31 - Set this bit to clear statistic counters."]
    #[inline]
    ...
    #[doc = "Bit 30 - Set this bit to enable statistic counters."]
    #[inline]
    ...
    #[doc = "Bit 29 - 0: The in-built clock gate functionality is bypassed. 1: The in-built clock gate functionality is enabled, automatically gating the clock when not needed."]
    #[inline]
    ...
    #[doc = "Bits 6:28 - Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 5 - Icode/Dcode flash line buffer control 0: Enable 1: Disable"]
    #[inline]
    ...
    #[doc = "Bit 4 - Sysbus flash line buffer control 0: Enable 1: Disable"]
    #[inline]
    ...
    #[doc = "Bit 3 - Icode/Dcode and sysbus arbitation scheme 0: Static arbitration (icode/docde > sysbus) 1: Round-robin arbitration"]
    #[inline]
    ...
    #[doc = "Bit 2 - Tag prefetch control 0: Disabled 1: Enabled"]
    #[inline]
    ...
    #[doc = "Bits 0:1 - VIMS mode request. Write accesses to this field will be blocked while STAT.MODE_CHANGING is set to 1. Note: Transaction from CACHE mode to GPRAM mode should be done through OFF mode to minimize flash block delay."]
    #[inline]
