...
impl R {
    ...
    #[doc = "Bits 0:7 - Write 1 to bit index n in this bit vector to set AUXIO\\[8i+n\\]. Write 0 to bit index n in this bit vector to clear AUXIO\\[8i+n\\]."]
    #[inline]
