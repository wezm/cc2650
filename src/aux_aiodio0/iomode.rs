...
impl R {
    ...
    #[doc = "Bits 14:15 - Select mode for AUXIO\\[8i+7\\]."]
    #[inline]
    ...
    #[doc = "Bits 12:13 - Select mode for AUXIO\\[8i+6\\]."]
    #[inline]
    ...
    #[doc = "Bits 10:11 - Select mode for AUXIO\\[8i+5\\]."]
    #[inline]
    ...
    #[doc = "Bits 8:9 - Select mode for AUXIO\\[8i+4\\]."]
    #[inline]
    ...
    #[doc = "Bits 6:7 - Select mode for AUXIO\\[8i+3\\]."]
    #[inline]
    ...
    #[doc = "Bits 4:5 - Select mode for AUXIO\\[8i+2\\]."]
    #[inline]
    ...
    #[doc = "Bits 2:3 - Select mode for AUXIO\\[8i+1\\]."]
    #[inline]
    ...
    #[doc = "Bits 0:1 - Select mode for AUXIO\\[8i+0\\]."]
    #[inline]
